...
sender_username = "accforperf@i.am"
sender_password = "Iamworld"
...
def populateInbox(subject, loopCount):

    FROM = sender_username
    TO = [To]
    SUBJECT = subject
    TEXT = rand_name_gen + " is a randon name generated from the names lib. "
    message = """\From: %s\nTo: %s\nSubject: %s\n\n%s
    ...
    try:
        ...
        server.close()
        print "Successfully sent email - " + loopCount
        time.sleep(2)
